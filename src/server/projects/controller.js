  ...
  handler: (request, h) => {
    const projects = {
      'cdp-platform': {
        ...
        commentary:
          'Platform demonstrates excellent alignment with GDS standards, with strong focus on user needs and open development practices.',
        standards: [
          {
            number: 1,
            ...
            status: 'GREEN',
            commentary:
              'Extensive user research with service teams and clear understanding of developer needs'
          },
          {
            number: 2,
            ...
            status: 'GREEN',
            commentary:
              'Platform provides end-to-end solution for service deployment and management'
          },
          {
            number: 3,
          ...
          },
          {
            ...
            status: 'GREEN',
            commentary:
              'Strong security controls and privacy-by-design approach'
          },
          {
            number: 10,
      ...
      'elm-payment-services': {
        ...
        commentary:
          'Service requires significant improvements to meet GDS standards. Major concerns around security, reliability and user research.',
        standards: [
          {
            number: 1,
            name: 'Understand users and their needs',
            status: 'RED',
            commentary:
              'Limited user research conducted, needs more engagement with farmers'
          },
          {
            number: 2,
            name: 'Solve a whole problem for users',
            status: 'AMBER',
            commentary:
              'Gaps in payment journey, particularly around payment status tracking'
          },
          {
            number: 3,
            name: 'Provide a joined up experience across all channels',
            status: 'RED',
            commentary:
              'Inconsistent experience between digital and paper channels'
          },
          {
            number: 4,
            name: 'Make the service simple to use',
            status: 'RED',
            commentary:
              'Complex processes and technical language creating barriers'
          },
          {
            number: 5,
            name: 'Make sure everyone can use the service',
            status: 'RED',
            commentary:
              'Accessibility issues identified, needs comprehensive review'
          },
          {
            number: 6,
            name: 'Have a multidisciplinary team',
